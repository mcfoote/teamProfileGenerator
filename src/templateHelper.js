...
<div class="card employee-card">
    ...
    <div class="card-body">
        <ul class="list-group">
            ...
            <li class="list-group-item">GitHub: <a href="https://github.com/${engineer.getGithub()}" target="blank">${engineer.getGithub()}</a></li>
        </ul>
    </div>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="row team-area col-12 justify-content-center d-flex">
                ${generateTeam(team)}
            </div>
        </div>
    </div>
